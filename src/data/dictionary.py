...
class MaskedDictionary(object):
    ...
    def add_extra_special_tokens(self, sym):
    ...
    def encode_line(
        ...
        append_eos=True,
        reverse_order=False,
        copy_ext_dict=False, copy_src_words=None,
        out_words=None
    ):
    ...
    def add_file_to_dictionary(filename, dict, tokenize, num_workers):
        ...
        if num_workers > 1:
            ...
            for worker_id in range(num_workers):
                results.append(
                    pool.apply_async(
                        MaskedDictionary._add_file_to_dictionary_single_worker,
